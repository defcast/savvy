(function( $ ) {// jscs:ignore validateLineBreaks
  ...
  api.CNCLogoDimension = api.Control.extend( {
    ...
    ready: function() {
      ...
      dimensions = control.container.find( '.CNC-dimension' );
      ...
      control.widthElement.keyup( function() {
        if ( control.hasLogo ) {
          ...
          control.CNCInterval = setInterval( control.updateControl, 1000, control );
        }
      } );
    ...
    calculateRatio: function( keep ) {
      ...
      clearInterval( control.CNCInterval );
    },
  ...
  $.extend( api.controlConstructor, {
    'CNC-logo-dimension': api.CNCLogoDimension
  } );
